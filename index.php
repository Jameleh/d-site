  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2> Apache && Nginx </h2></a>
    ...
    <div class="request-form">\
        <div class="container">  <div class="row"><b> Our Customer</b> <br /> </row> </div>
      <div class="container">
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
    echo "id: " . $row["customer_id"]. " - Name: " . $row["first_name"]. " " . $row["last_name"]." - birth date: ". $row["birth_date"]." - phone: ". $row["phone"]." - address: ". $row["address"] ."<br>";
}
}
